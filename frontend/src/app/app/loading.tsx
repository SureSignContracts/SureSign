...
// app route resolves (dev: Turbopack's on-demand compile; any mode: a
// slower data fetch). Renders inside AppLayout's already-mounted sidebar
...
// state, absent entirely in production.
