...
class Organization extends Model {
    ...
    protected $fillable = ['name','contact_name','slug','email','phone','website','address','city','state','postcode','country','registration_number','vat_number','abn','acn','is_active','is_onboarded'];
