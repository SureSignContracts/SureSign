...
export const metadata: Metadata = {
  title: 'Terms of Use',
  description: 'Terms governing access to and use of the SureSign Contracts platform.',
    ...
    <>
      ...
      <main id="main-content">
        <LegalDocument
          ...
          title="Terms of Use"
          updated="June 2026"
          introduction="These Terms of Use govern your access to and use of the SureSign Contracts platform. Please read them carefully before using the service."
          sections={sections}
        />
      </main>
      <Footer />
